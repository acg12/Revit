 ...
 * Use the [FragmentComments.newInstance] factory method to
...
class FragmentComments : Fragment() {
    ...
    override fun onCreateView(
        ...
        val rv: RecyclerView = view.findViewById(R.id.rvComments)
        val dataSet: ArrayList<Comment> = ArrayList()
        val idSet: ArrayList<String> = ArrayList()
        val adapter = CommentAdapter(dataSet, idSet, "comments")
